        ...
        while (!feof(fSteeringFile)) {
            ...
            if ((line[0]!='#')&&(line[0]!='\n')&&(line[0]!='\r')) {
                ...
                if (strcmp(tmpString1,"G4EmExtraPhysics")==0 && strcmp(tmpString2,"SetCrossSecFactor")==0){
                    ...
                    else if(strcmp(factorName,"pnFactor")==0){
                        pnFactor = factor;
                    }
                    else {
...
void G4EmExtraPhysics::ConstructGammaElectroNuclear()
{
    ...
    gnuc->BiasCrossSectionByFactor(pnFactor); // added by KSK, default = 1.0
    ...
    if(eActivated) {
        ...
        if(eproc != nullptr) {
            ...
            enuc->BiasCrossSectionByFactor(enFactor); // added by KSK, default = 1.0
        ...
        if(pproc != nullptr) {
            ...
            pnuc->BiasCrossSectionByFactor(1.0); // added by KSK, default = 1.0
